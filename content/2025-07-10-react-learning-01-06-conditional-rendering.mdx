...
컴포넌트가 다른 조건에 따라 다른 내용을 표시하는 것입니다.

React에서는 JavaScript 문법(`if`, `&&`, `? :`)을 사용하여 조건부로 JSX를 렌더링합니다.

### 방법 1: `if` 문 사용

가장 기본적인 방법으로, 조건에 따라 다른 JSX를 반환합니다.
...
JSX 안에서 직접 조건부 표현식을 사용할 때 유용합니다.
...
조건이 참일 때만 무언가를 보여주고 싶을 때 사용합니다.
...
복잡한 조건 로직을 깨끗하게 분리하고 싶을 때 사용합니다.
