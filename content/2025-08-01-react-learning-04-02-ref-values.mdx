...
State는 변경 시 리렌더링을 일으킵니다. 하지만 때로는 리렌더링 없이 값을 저장하고 싶을 때가 있습니다.
...
Ref의 실용적인 사용 예제를 보겠습니다. interval ID를 저장하는 데 ref를 사용합니다.
...
Ref를 언제 사용해야 할까요? 일반적으로 React 외부 시스템과 상호작용할 때 유용합니다.
...
Ref가 리렌더링을 일으키지 않는다는 것을 보여주는 간단한 예제입니다.
