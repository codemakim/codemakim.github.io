...
export const SLIME: EnemyDef = {
  ...
  patterns: [
    ...
    { weight: 1, intent: 'attack', intentValue: 3, action: { type: 'attack', damage: 3, times: 2, vfx: 'impact' } },
  ],
};
...
export const MUSHROOM: EnemyDef = {
  ...
  patterns: [
    ...
    { weight: 4, intent: 'attack', intentValue: 5, action: { type: 'attack', damage: 5, vfx: 'poison' } },
  ],
};
  ...
  patterns: [
    { weight: 1, intent: 'attack', intentValue: 15, action: { type: 'attack', damage: 15, vfx: 'slash' } },
    {
      weight: 1, intent: 'buff', action: {
        type: 'multi', vfx: 'shield', actions: [
          { type: 'block', value: 12 },
          { type: 'buff', buff: 'strength', value: 1, target: 'self' },
        ]
      }
    },
    { weight: 1, intent: 'attack', intentValue: 8, action: { type: 'attack', damage: 8, times: 2, vfx: 'slash' } },
  ],
};
  ...
  patterns: [
    {
      weight: 1, intent: 'attack', intentValue: 10, action: {
        type: 'multi', vfx: 'magic', actions: [
          { type: 'attack', damage: 10, vfx: 'magic' },
          { type: 'debuff', buff: 'poison', value: 2, target: 'player' },
        ]
      }
    },
    { weight: 1, intent: 'attack', intentValue: 7, action: { type: 'attack', damage: 7, vfx: 'magic' } },
...
export const SHADOW_THIEF: EnemyDef = {
  ...
  patterns: [
    ...
    { weight: 1, intent: 'attack', intentValue: 20, action: { type: 'attack', damage: 20, vfx: 'pierce' } },
  ],
};
...
export const GOLEM: EnemyDef = {
  ...
  patterns: [
    ...
    { weight: 1, intent: 'special', intentValue: 20, action: { type: 'attack', damage: 20, vfx: 'impact' } },
  ],
};
...
export const LICH: EnemyDef = {
  ...
  patterns: [
    ...
    { weight: 1, intent: 'buff', action: { type: 'buff', buff: 'strength', value: 2, target: 'self' } },
    {
      weight: 1, intent: 'debuff', action: {
        type: 'multi', vfx: 'magic', actions: [
          { type: 'attack', damage: 8, vfx: 'magic' },
          { type: 'debuff', buff: 'weak', value: 2, target: 'player' },
        ]
      }
    },
...
export const DRAGON: EnemyDef = {
  ...
  patterns: [
    ...
    { weight: 1, intent: 'special', intentValue: 25, action: { type: 'attack', damage: 25, vfx: 'magic' } },
  ],
};
